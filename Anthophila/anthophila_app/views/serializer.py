...
from anthophila_app.models import Beehive, Beeyard
...
class BeekeeperSerializer(serializers.ModelSerializer):
    beeyard_extended = BeeyardDetailedSerializer(source="beeyard", read_only=True)

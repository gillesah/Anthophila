...
from public.views import BeeyardViewSet, BeehiveViewSet, BeekeeperViewSet, ContaminatedViewSet
...
router_public.register(r'beeyards', BeeyardViewSet)
router_public.register(r'beehives', BeehiveViewSet)
router_public.register(r'beekeepers', BeekeeperViewSet)
router_public.register(r'contaminated', ContaminatedViewSet)
urlpatterns = [
